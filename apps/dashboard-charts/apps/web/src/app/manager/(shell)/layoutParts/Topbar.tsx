  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
        <div style={card}><div style={cardTitle}>Projects</div><div>0 active (placeholder)</div></div>
        <div style={card}><div style={cardTitle}>Spend (30d)</div><div>$0.00 (placeholder)</div></div>
        <div style={card}><div style={cardTitle}>Deploy health</div><div>OK (placeholder)</div></div>
      </div>
    </div>
  );
}
